...
namespace DataLine.DataLine10
{
    ...
    public class service_spec_acl : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.DataLine10.grp fgroup_id;
        ...
        [PropertyStorage(new string[] {
                "group_id"})]
        [NotNull()]
        public virtual DataLine.DataLine10.grp group_id
        {
            get
            {
                ...
                DataLine.DataLine10.grp result = this.fgroup_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View service_spec_aclE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_spec_aclE", typeof(DataLine.DataLine10.service_spec_acl));
                }
            }
            ...
            public static ICSSoft.STORMNET.View service_spec_aclL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_spec_aclL", typeof(DataLine.DataLine10.service_spec_acl));
                }
            }
        }
    }
