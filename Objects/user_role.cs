...
namespace DataLine.DataLine10
{
    ...
    public class user_role : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.DataLine10.role frole_id;
        ...
        [PropertyStorage(new string[] {
                "role_id"})]
        [NotNull()]
        public virtual DataLine.DataLine10.role role_id
        {
            get
            {
                ...
                DataLine.DataLine10.role result = this.frole_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View user_roleE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("user_roleE", typeof(DataLine.DataLine10.user_role));
                }
            }
            ...
            public static ICSSoft.STORMNET.View user_roleL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("user_roleL", typeof(DataLine.DataLine10.user_role));
                }
            }
        }
    }
