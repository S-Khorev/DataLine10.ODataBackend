...
namespace DataLine.DataLine10
{
    ...
    public class dba : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.DataLine10.dba fprev_version;
        ...
        [PropertyStorage(new string[] {
                "prev_version"})]
        public virtual DataLine.DataLine10.dba prev_version
        {
            get
            {
                ...
                DataLine.DataLine10.dba result = this.fprev_version;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View dbaE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("dbaE", typeof(DataLine.DataLine10.dba));
                }
            }
            ...
            public static ICSSoft.STORMNET.View dbaL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("dbaL", typeof(DataLine.DataLine10.dba));
                }
            }
        }
    }
