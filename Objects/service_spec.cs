...
namespace DataLine.DataLine10
{
    ...
    public class service_spec : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.DataLine10.catalog fcatalog_key;
        
        private DataLine.DataLine10.cardinality_type fcardinality;
        
        private DataLine.DataLine10.service_spec fparent_id;
        ...
        public virtual DataLine.DataLine10.catalog catalog_key
        {
            get
            {
                ...
                DataLine.DataLine10.catalog result = this.fcatalog_key;
        ...
        [NotNull()]
        public virtual DataLine.DataLine10.service_spec parent_id
        {
            get
            {
                ...
                DataLine.DataLine10.service_spec result = this.fparent_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View service_specE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_specE", typeof(DataLine.DataLine10.service_spec));
                }
            }
            ...
            public static ICSSoft.STORMNET.View service_specL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_specL", typeof(DataLine.DataLine10.service_spec));
                }
            }
        }
    }
