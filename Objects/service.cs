...
namespace DataLine.DataLine10
{
    ...
    public class service : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.DataLine10.service fparent_id;
        
        private DataLine.DataLine10.service_state fstate;
        
        private DataLine.DataLine10.service_spec fservice_spec_id;
        ...
        [PropertyStorage(new string[] {
                "parent_id"})]
        public virtual DataLine.DataLine10.service parent_id
        {
            get
            {
                ...
                DataLine.DataLine10.service result = this.fparent_id;
        ...
        [NotNull()]
        public virtual DataLine.DataLine10.service_state state
        {
            get
            {
                ...
                DataLine.DataLine10.service_state result = this.fstate;
        ...
        [PropertyStorage(new string[] {
                "service_spec_id"})]
        [NotNull()]
        public virtual DataLine.DataLine10.service_spec service_spec_id
        {
            get
            {
                ...
                DataLine.DataLine10.service_spec result = this.fservice_spec_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View serviceE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("serviceE", typeof(DataLine.DataLine10.service));
                }
            }
            ...
            public static ICSSoft.STORMNET.View serviceL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("serviceL", typeof(DataLine.DataLine10.service));
                }
            }
        }
    }
